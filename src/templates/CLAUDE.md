...
Your tool calls, token usage, and costs are **automatically captured** by SwarmOps hooks. You do not need to manually report every action.

## Optional: Explicit Messages & Decisions

Use the SwarmOps CLI when you want to post a human-readable status update or log an architectural decision:
